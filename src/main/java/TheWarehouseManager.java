...
public class TheWarehouseManager {
   ...
   private String seekUserName() {
    ...
    private void logIn(String userName) {
        while (!TheWarehouseApp.IS_EMPLOYEE) {
            ...
            if (UserRepository.isUserValid(userName, password)) {
                ...
                this.currentUser = new Employee(userName, password);
    ...
    private void greetUser() {
        ...
        if (UserRepository.isUserEmployee(userName)) logIn(userName);
        if (!TheWarehouseApp.IS_EMPLOYEE) this.currentUser = new User(userName);
        currentUser.greet();
    }
    ...
    private void searchItemAndPlaceOrder() {
        ...
        if (totalAmount == 0) {
            ...
            if (this.confirm("Would you like to order this item?")) {
                this.logIn(currentUser.getName());
